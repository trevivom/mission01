package com.example.mission01.domain;
...
public class Wifiinfo {
    ...
    public String getIntstallTy() {
        return intstallTy;
    }

    public void setIntstallTy(String intstallTy) {
        this.intstallTy = intstallTy;
    }
